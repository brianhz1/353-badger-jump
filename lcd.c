...
/*****************************************************************************
 * Clears entire LCD by drawing a black rectangle
 ****************************************************************************/
void lcd_clear_screen(void)
{
    lcd_draw_rectangle(LCD_HORIZONTAL_MAX / 2, LCD_VERTICAL_MAX / 2, LCD_HORIZONTAL_MAX, LCD_VERTICAL_MAX, background_color);
}
